	...
	<body>
        <div class="container-fluid mobile-header">
                    ...
                    <div class="col-md-6 top-right">
                        <div class="row">
                            ...
                            <div class="col-md-3 social_links">
                                ...
                                <a href=""><img src="img/instagram.png" class="img-responsive"/></a>
                            </div>
                            <div class="col-md-6 main-search">
            ...
            <div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse" id="mobile-toggle" data-target="#navbar-collapse-1">
            ...
            <div class="row full-nav">
                <div class="col-md-12">
		            <nav class="navbar navbar nav-adjust" role="navigation">
				        <ul class="nav navbar-nav mobile-nav">
					        <li>
						        <a href=""><span class="glyphicon glyphicon-home"> </span></a>
					        </li>
					        <li>
						        <a href="" data-toggle="dropdown"> RESIDENTIAL <span class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li class="dropdown-submenu">
                                        <a href="#">Buy</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="search_property.php">Resale</a></li>
                                            <li><a href="search_property.php">New Project-Luxury</a></li>
                    	                    <li><a href="search_property.php">New Project-Value</a></li>
                                        </ul>
                                      </li>
                                    <li class="dropdown-submenu">
                                        <a href="#">Take on Rent</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="search_property.php">Resale</a></li>
                                            <li><a href="search_property.php">New Project-Luxury</a></li>
                    	                    <li><a href="search_property.php">New Project-Value</a></li>
                                    ...
                                    <li><a href="#">Offer for Rent</a></li>
                                    
                                </ul>
					        </li>
					        <li>
						        <a href="" data-toggle="dropdown"> COMMERCIAL <span class="caret"></a>
                                <ul class="dropdown-menu" role="menu">
                                     <li class="dropdown-submenu">
                                        <a href="#">Buy</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="search_property.php">Resale</a></li>
                                            <li><a href="search_property.php">New Project</a></li>
                                        </ul>
                                      </li>
                                    <li class="dropdown-submenu">
                                        <a href="#">Take on Rent</a>
